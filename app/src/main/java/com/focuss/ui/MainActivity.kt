...
import com.focuss.ui.screens.AppSelectionScreen
import com.focuss.ui.screens.HomeScreen
import com.focuss.ui.screens.PermissionsScreen
import com.focuss.ui.screens.ScheduleEditorScreen
import com.focuss.ui.screens.SettingsScreen
import com.focuss.ui.screens.SplashScreen
...
private fun FocussApp(vm: FocussViewModel) {
    ...
    fun lockedToast() =
        Toast.makeText(context, context.getString(com.focuss.R.string.session_locked_toast), Toast.LENGTH_SHORT).show()
